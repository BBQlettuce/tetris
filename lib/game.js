(function () {
  ...
  Game.prototype.restartGame = function() {
    ...
    //   console.log("enter to restart game")
    //   this.gamePaused = false;
    //   this._gamePrepped = false;
    //   if ($(".timer").data('state') === "stopped") {
    //     $(".timer").timer('start');
    //   } else if ($(".timer").data('state') === "paused") {
    //     $(".timer").timer('resume');
    //   }
    // } else {
      console.log("enter to start game")
  ...
  Game.prototype.run = function() {
    ...
    window.setInterval(function() {
      if (!game.gamePaused && !game.gameOver) {
        ...
        if (game.board.reachedTop() || game.scoreView.score >= 1 ) {
          game.end();
        };
      }
    }, 250)
  ...
  Game.prototype.end = function() {
    $(".timer").timer('pause');
    this.gameOver = true;
    this.board.reachedTop() ? this.board.showLoss() : this.board.showWin();
  }
